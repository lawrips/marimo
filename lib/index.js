...
class Marimo {
            ...
            ws.on('message', (data, flags) => {                
                ...
                try {                    
                    ...
                    if (message.monitor) {
                        ...
                        if (this.tests[message.test]) {
                            // spawn a new process to run the test
                            ...
                            debug(`did not find file for mocha test=${message.test}`);
    ...
    _runOnce(ws, env, test, reporter, callback) {
        // load the script
        ...
        // find an open port (required for debug which is mandatory)
