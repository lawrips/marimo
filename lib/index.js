...
class Marimo {
     ...
     * @param {Number} [options.debugPort=12141] - The port which will be used for the debugger when launching mocha
    ...
    constructor(options) {
        ...
        this.monitors = [];
        this.monitorOptions = {};
        this.debugPort = options.debugPort || 12141; // advanced mode (only change this if the default port of 12141 is being used)
    }
